## eggNOG external-data builder.
##
## These helpers used to live in `data-raw/build_eggnog.R`. `data-raw/` is
...
## `tests/testthat/test_build_eggnog.R` exercises shipped code, while
## `data-raw/build_eggnog.R` stays a thin loader for the update workflow.
